...
$('p#message').html("Please wait, finding location...");

// Watch the user's location
navigator.geolocation.watchPosition(foundYou);
...
function foundYou(yourPosition){
  ...
  var targetLat = 51.5226173;
  var targetLon = -0.1076117;
  ...
  if (distance < geofence){
    ...
    $('form').hide();
    $('p#message').html("Nearly here... You are only " + distance.toFixed(1) + "km away");
  }
